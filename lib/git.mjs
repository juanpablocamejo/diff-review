...
/**
 * Si `cwd` está dentro de un repo git, devuelve la raíz absoluta; si no, null.
 * Acepta subcarpetas (usa `git rev-parse --show-toplevel`).
 */
export function tryResolveGitRoot(cwd) {
